...
namespace Sokol
{
    public static unsafe class sokol_gfx
    {
        ...
        public struct sg_color_attachment_action
        {
            ...
            [FieldOffset(4)] public Rgba32F val;
        }
        ...
        public struct sg_pass_action
        {
            ...
            public static sg_pass_action clear(Rgba32F? color = null)
            {
                ...
                colorAttachment0.val = color ?? Rgba32F.Gray;
                return passAction;
            }
        ...
        {
            [FieldOffset(0)] public fixed ulong _subimage[16 * (int) sg_cube_face.SG_CUBEFACE_NUM * SG_MAX_MIPMAPS / 8];
        ...
        public struct sg_shader_stage_desc
        {
            ...
            [FieldOffset(32)] public fixed ulong _uniform_blocks[264 * SG_MAX_SHADERSTAGE_UBS / 8];
        ...
        public struct sg_blend_state
        {
            ...
            [FieldOffset(44)] public Rgba32F blend_color;
        }
        ...
        {
            private const string LibraryName = "sokol_gfx-directx";
