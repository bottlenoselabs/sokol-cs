...
public static unsafe partial class sokol
{
    ...
    public const uint SG_CUBEFACE_POS_X = 0;
    public const uint SG_CUBEFACE_NEG_X = 1;
    public const uint SG_CUBEFACE_POS_Y = 2;
    public const uint SG_CUBEFACE_NEG_Y = 3;
    public const uint SG_CUBEFACE_POS_Z = 4;
    public const uint SG_CUBEFACE_NEG_Z = 5;
    public const uint SG_CUBEFACE_NUM = 6;
    public const uint _SG_CUBEFACE_FORCE_U32 = 2147483647;
}
