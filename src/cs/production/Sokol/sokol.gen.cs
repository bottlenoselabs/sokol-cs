// <auto-generated>
//  This code was generated by the following tool on 2023-05-11 01:05:08 GMT+00:00:
...
namespace bottlenoselabs
{
    public static unsafe partial class sokol
    {
        ...
        public enum sg_log_item : int
        {
            ...
            SG_LOGITEM_VALIDATE_IMAGEDESC_RT_IMMUTABLE = 96,
            SG_LOGITEM_VALIDATE_IMAGEDESC_RT_NO_DATA = 97,
            SG_LOGITEM_VALIDATE_IMAGEDESC_INJECTED_NO_DATA = 98,
            SG_LOGITEM_VALIDATE_IMAGEDESC_DYNAMIC_NO_DATA = 99,
            SG_LOGITEM_VALIDATE_IMAGEDESC_COMPRESSED_IMMUTABLE = 100,
            SG_LOGITEM_VALIDATE_SHADERDESC_CANARY = 101,
            SG_LOGITEM_VALIDATE_SHADERDESC_SOURCE = 102,
            SG_LOGITEM_VALIDATE_SHADERDESC_BYTECODE = 103,
            SG_LOGITEM_VALIDATE_SHADERDESC_SOURCE_OR_BYTECODE = 104,
            SG_LOGITEM_VALIDATE_SHADERDESC_NO_BYTECODE_SIZE = 105,
            SG_LOGITEM_VALIDATE_SHADERDESC_NO_CONT_UBS = 106,
            SG_LOGITEM_VALIDATE_SHADERDESC_NO_CONT_UB_MEMBERS = 107,
            SG_LOGITEM_VALIDATE_SHADERDESC_NO_UB_MEMBERS = 108,
            SG_LOGITEM_VALIDATE_SHADERDESC_UB_MEMBER_NAME = 109,
            SG_LOGITEM_VALIDATE_SHADERDESC_UB_SIZE_MISMATCH = 110,
            SG_LOGITEM_VALIDATE_SHADERDESC_UB_ARRAY_COUNT = 111,
            SG_LOGITEM_VALIDATE_SHADERDESC_UB_STD140_ARRAY_TYPE = 112,
            SG_LOGITEM_VALIDATE_SHADERDESC_NO_CONT_IMGS = 113,
            SG_LOGITEM_VALIDATE_SHADERDESC_IMG_NAME = 114,
            ...
            SG_LOGITEM_VALIDATE_PIPELINEDESC_ATTR_SEMANTICS = 121,
            SG_LOGITEM_VALIDATE_PASSDESC_CANARY = 122,
            SG_LOGITEM_VALIDATE_PASSDESC_NO_COLOR_ATTS = 123,
            SG_LOGITEM_VALIDATE_PASSDESC_NO_CONT_COLOR_ATTS = 124,
            SG_LOGITEM_VALIDATE_PASSDESC_IMAGE = 125,
            SG_LOGITEM_VALIDATE_PASSDESC_MIPLEVEL = 126,
            SG_LOGITEM_VALIDATE_PASSDESC_FACE = 127,
            SG_LOGITEM_VALIDATE_PASSDESC_LAYER = 128,
            SG_LOGITEM_VALIDATE_PASSDESC_SLICE = 129,
            SG_LOGITEM_VALIDATE_PASSDESC_IMAGE_NO_RT = 130,
            SG_LOGITEM_VALIDATE_PASSDESC_COLOR_INV_PIXELFORMAT = 131,
            SG_LOGITEM_VALIDATE_PASSDESC_DEPTH_INV_PIXELFORMAT = 132,
            SG_LOGITEM_VALIDATE_PASSDESC_IMAGE_SIZES = 133,
            SG_LOGITEM_VALIDATE_PASSDESC_IMAGE_SAMPLE_COUNTS = 134,
            SG_LOGITEM_VALIDATE_BEGINPASS_PASS = 135,
            SG_LOGITEM_VALIDATE_BEGINPASS_IMAGE = 136,
            SG_LOGITEM_VALIDATE_APIP_PIPELINE_VALID_ID = 137,
            SG_LOGITEM_VALIDATE_APIP_PIPELINE_EXISTS = 138,
            SG_LOGITEM_VALIDATE_APIP_PIPELINE_VALID = 139,
            SG_LOGITEM_VALIDATE_APIP_SHADER_EXISTS = 140,
            SG_LOGITEM_VALIDATE_APIP_SHADER_VALID = 141,
            SG_LOGITEM_VALIDATE_APIP_ATT_COUNT = 142,
            SG_LOGITEM_VALIDATE_APIP_COLOR_FORMAT = 143,
            SG_LOGITEM_VALIDATE_APIP_DEPTH_FORMAT = 144,
            SG_LOGITEM_VALIDATE_APIP_SAMPLE_COUNT = 145,
            SG_LOGITEM_VALIDATE_ABND_PIPELINE = 146,
            SG_LOGITEM_VALIDATE_ABND_PIPELINE_EXISTS = 147,
            SG_LOGITEM_VALIDATE_ABND_PIPELINE_VALID = 148,
            SG_LOGITEM_VALIDATE_ABND_VBS = 149,
            SG_LOGITEM_VALIDATE_ABND_VB_EXISTS = 150,
            SG_LOGITEM_VALIDATE_ABND_VB_TYPE = 151,
            SG_LOGITEM_VALIDATE_ABND_VB_OVERFLOW = 152,
            SG_LOGITEM_VALIDATE_ABND_NO_IB = 153,
            SG_LOGITEM_VALIDATE_ABND_IB = 154,
            SG_LOGITEM_VALIDATE_ABND_IB_EXISTS = 155,
            SG_LOGITEM_VALIDATE_ABND_IB_TYPE = 156,
            SG_LOGITEM_VALIDATE_ABND_IB_OVERFLOW = 157,
            SG_LOGITEM_VALIDATE_ABND_VS_IMGS = 158,
            SG_LOGITEM_VALIDATE_ABND_VS_IMG_EXISTS = 159,
            SG_LOGITEM_VALIDATE_ABND_VS_IMG_TYPES = 160,
            SG_LOGITEM_VALIDATE_ABND_FS_IMGS = 161,
            SG_LOGITEM_VALIDATE_ABND_FS_IMG_EXISTS = 162,
            SG_LOGITEM_VALIDATE_ABND_FS_IMG_TYPES = 163,
            SG_LOGITEM_VALIDATE_AUB_NO_PIPELINE = 164,
            SG_LOGITEM_VALIDATE_AUB_NO_UB_AT_SLOT = 165,
            SG_LOGITEM_VALIDATE_AUB_SIZE = 166,
            SG_LOGITEM_VALIDATE_UPDATEBUF_USAGE = 167,
            SG_LOGITEM_VALIDATE_UPDATEBUF_SIZE = 168,
            SG_LOGITEM_VALIDATE_UPDATEBUF_ONCE = 169,
            SG_LOGITEM_VALIDATE_UPDATEBUF_APPEND = 170,
            SG_LOGITEM_VALIDATE_APPENDBUF_USAGE = 171,
            SG_LOGITEM_VALIDATE_APPENDBUF_SIZE = 172,
            SG_LOGITEM_VALIDATE_APPENDBUF_UPDATE = 173,
            SG_LOGITEM_VALIDATE_UPDIMG_USAGE = 174,
            SG_LOGITEM_VALIDATE_UPDIMG_ONCE = 175,
            SG_LOGITEM_VALIDATION_FAILED = 176
        }
