// <auto-generated>
//  This code was generated by the following tool on 2023-05-22 03:37:58 GMT+00:00:
...
public static unsafe partial class PInvoke
{
    ...
    public static unsafe partial class Graphics
    {
        ...
        public enum LogItem : int
        {
            ...
            UninitShaderActiveContextMismatch = 50,
            UninitPipelineActiveContextMismatch = 51,
            UninitPassActiveContextMismatch = 52,
            IdenticalCommitListener = 53,
            CommitListenerArrayFull = 54,
            TraceHooksNotEnabled = 55,
            DeallocBufferInvalidState = 56,
            DeallocImageInvalidState = 57,
            DeallocShaderInvalidState = 58,
            DeallocPipelineInvalidState = 59,
            DeallocPassInvalidState = 60,
            InitBufferInvalidState = 61,
            InitImageInvalidState = 62,
            InitShaderInvalidState = 63,
            InitPipelineInvalidState = 64,
            InitPassInvalidState = 65,
            UninitBufferInvalidState = 66,
            UninitImageInvalidState = 67,
            UninitShaderInvalidState = 68,
            UninitPipelineInvalidState = 69,
            UninitPassInvalidState = 70,
            FailBufferInvalidState = 71,
            FailImageInvalidState = 72,
            FailShaderInvalidState = 73,
            FailPipelineInvalidState = 74,
            FailPassInvalidState = 75,
            BufferPoolExhausted = 76,
            ImagePoolExhausted = 77,
            ShaderPoolExhausted = 78,
            PipelinePoolExhausted = 79,
            PassPoolExhausted = 80,
            DrawWithoutBindings = 81,
            ValidateBufferdescCanary = 82,
            ValidateBufferdescSize = 83,
            ValidateBufferdescData = 84,
            ValidateBufferdescDataSize = 85,
            ValidateBufferdescNoData = 86,
            ValidateImagedataNodata = 87,
            ValidateImagedataDataSize = 88,
            ValidateImagedescCanary = 89,
            ValidateImagedescWidth = 90,
            ValidateImagedescHeight = 91,
            ValidateImagedescRtPixelformat = 92,
            ValidateImagedescNonrtPixelformat = 93,
            ValidateImagedescMsaaButNoRt = 94,
            ValidateImagedescNoMsaaRtSupport = 95,
            ValidateImagedescMsaaNumMipmaps = 96,
            ValidateImagedescMsaa3dImage = 97,
            ValidateImagedescDepth3dImage = 98,
            ValidateImagedescRtImmutable = 99,
            ValidateImagedescRtNoData = 100,
            ValidateImagedescInjectedNoData = 101,
            ValidateImagedescDynamicNoData = 102,
            ValidateImagedescCompressedImmutable = 103,
            ValidateShaderdescCanary = 104,
            ValidateShaderdescSource = 105,
            ValidateShaderdescBytecode = 106,
            ValidateShaderdescSourceOrBytecode = 107,
            ValidateShaderdescNoBytecodeSize = 108,
            ValidateShaderdescNoContUbs = 109,
            ValidateShaderdescNoContUbMembers = 110,
            ValidateShaderdescNoUbMembers = 111,
            ValidateShaderdescUbMemberName = 112,
            ValidateShaderdescUbSizeMismatch = 113,
            ValidateShaderdescUbArrayCount = 114,
            ValidateShaderdescUbStd140ArrayType = 115,
            ValidateShaderdescNoContImgs = 116,
            ValidateShaderdescImgName = 117,
            ValidateShaderdescAttrSemantics = 118,
            ValidateShaderdescAttrStringTooLong = 119,
            ValidatePipelinedescCanary = 120,
            ValidatePipelinedescShader = 121,
            ValidatePipelinedescNoAttrs = 122,
            ValidatePipelinedescLayoutStride4 = 123,
            ValidatePipelinedescAttrSemantics = 124,
            ValidatePassdescCanary = 125,
            ValidatePassdescNoColorAtts = 126,
            ValidatePassdescNoContColorAtts = 127,
            ValidatePassdescImage = 128,
            ValidatePassdescMiplevel = 129,
            ValidatePassdescFace = 130,
            ValidatePassdescLayer = 131,
            ValidatePassdescSlice = 132,
            ValidatePassdescImageNoRt = 133,
            ValidatePassdescColorInvPixelformat = 134,
            ValidatePassdescDepthInvPixelformat = 135,
            ValidatePassdescImageSizes = 136,
            ValidatePassdescImageSampleCounts = 137,
            ValidatePassdescResolveColorImageMsaa = 138,
            ValidatePassdescResolveImage = 139,
            ValidatePassdescResolveSampleCount = 140,
            ValidatePassdescResolveMiplevel = 141,
            ValidatePassdescResolveFace = 142,
            ValidatePassdescResolveLayer = 143,
            ValidatePassdescResolveSlice = 144,
            ValidatePassdescResolveImageNoRt = 145,
            ValidatePassdescResolveImageSizes = 146,
            ValidatePassdescResolveImageFormat = 147,
            ValidatePassdescDepthImage = 148,
            ValidatePassdescDepthMiplevel = 149,
            ValidatePassdescDepthFace = 150,
            ValidatePassdescDepthLayer = 151,
            ValidatePassdescDepthSlice = 152,
            ValidatePassdescDepthImageNoRt = 153,
            ValidatePassdescDepthImageSizes = 154,
            ValidatePassdescDepthImageSampleCount = 155,
            ValidateBeginpassPass = 156,
            ValidateBeginpassColorAttachmentImage = 157,
            ValidateBeginpassResolveAttachmentImage = 158,
            ValidateBeginpassDepthstencilAttachmentImage = 159,
            ValidateApipPipelineValidId = 160,
            ValidateApipPipelineExists = 161,
            ValidateApipPipelineValid = 162,
            ValidateApipShaderExists = 163,
            ValidateApipShaderValid = 164,
            ValidateApipAttCount = 165,
            ValidateApipColorFormat = 166,
            ValidateApipDepthFormat = 167,
            ValidateApipSampleCount = 168,
            ValidateAbndPipeline = 169,
            ValidateAbndPipelineExists = 170,
            ValidateAbndPipelineValid = 171,
            ValidateAbndVbs = 172,
            ValidateAbndVbExists = 173,
            ValidateAbndVbType = 174,
            ValidateAbndVbOverflow = 175,
            ValidateAbndNoIb = 176,
            ValidateAbndIb = 177,
            ValidateAbndIbExists = 178,
            ValidateAbndIbType = 179,
            ValidateAbndIbOverflow = 180,
            ValidateAbndVsImgs = 181,
            ValidateAbndVsImgExists = 182,
            ValidateAbndVsImgTypes = 183,
            ValidateAbndVsImgMsaa = 184,
            ValidateAbndVsImgDepth = 185,
            ValidateAbndFsImgs = 186,
            ValidateAbndFsImgExists = 187,
            ValidateAbndFsImgTypes = 188,
            ValidateAbndFsImgMsaa = 189,
            ValidateAbndFsImgDepth = 190,
            ValidateAubNoPipeline = 191,
            ValidateAubNoUbAtSlot = 192,
            ValidateAubSize = 193,
            ValidateUpdatebufUsage = 194,
            ValidateUpdatebufSize = 195,
            ValidateUpdatebufOnce = 196,
            ValidateUpdatebufAppend = 197,
            ValidateAppendbufUsage = 198,
            ValidateAppendbufSize = 199,
            ValidateAppendbufUpdate = 200,
            ValidateUpdimgUsage = 201,
            ValidateUpdimgOnce = 202,
