...
namespace Samples.C.Quad
{
    internal static unsafe class Program
    {
        private static sg_buffer _vertexBuffer;
        private static sg_buffer _indexBuffer;
        ...
        private static void Run()
        {
            ...
            descriptor.window_title = UnmanagedStrings.GetBytes("Quad");
        ...
        private static void Frame()
        {
            ...
            resourceBindings.index_buffer = _indexBuffer;
        ...
        private static sg_buffer CreateIndexBuffer()
        {
            ...
            ref var reference = ref MemoryMarshal.GetReference(indices);
            bufferDesc.content = Unsafe.AsPointer(ref reference);
            bufferDesc.size = Marshal.SizeOf<ushort>() * indices.Length;
