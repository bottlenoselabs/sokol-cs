...
namespace Sokol.Graphics
{
    ...
    public static class Graphics
    {
        ...
        public static GraphicsDescriptor Descriptor => PInvoke.sg_query_desc();
        ...
        public static GraphicsFeatures Features => PInvoke.sg_query_features();
        ...
        public static GraphicsLimits Limits => PInvoke.sg_query_limits();
        ...
        public static void Setup(ref GraphicsDescriptor desc) => PInvoke.sg_setup(ref desc);
        ...
        ///     </para>
        /// </remarks>
        public static void Shutdown() => PInvoke.sg_shutdown();

        /// <summary>
        ///     Creates a <see cref="GraphicsContext" />.
        /// </summary>
        /// <returns>A <see cref="GraphicsContext" />.</returns>
        public static GraphicsContext SetupContext() => PInvoke.sg_setup_context();

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <returns>.</returns>
        public static GraphicsBuffer AllocBuffer() => PInvoke.sg_alloc_buffer();
        ...
        public static GraphicsBuffer MakeBuffer(ref GraphicsBufferDescriptor descriptor) => PInvoke.sg_make_buffer(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <returns>.</returns>
        public static GraphicsImage AllocImage() => PInvoke.sg_alloc_image();
        ...
        public static GraphicsImage MakeImage(ref GraphicsImageDescriptor descriptor) => PInvoke.sg_make_image(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <returns>.</returns>
        public static GraphicsPass AllocPass() => PInvoke.sg_alloc_pass();
        ...
        public static GraphicsPass MakePass(ref GraphicsPassDescriptor descriptor) => PInvoke.sg_make_pass(ref descriptor);

        /// <summary>
        /// TODO.
        /// </summary>
        /// <returns>.</returns>
        public static GraphicsPipeline AllocPipeline() => PInvoke.sg_alloc_pipeline();
        ...
        public static GraphicsPipeline MakePipeline(ref GraphicsPipelineDescriptor descriptor) => PInvoke.sg_make_pipeline(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <returns>.</returns>
        public static GraphicsShader AllocShader() => PInvoke.sg_alloc_shader();
        ...
        public static GraphicsShader MakeShader(ref GraphicsShaderDescriptor descriptor) => PInvoke.sg_make_shader(ref descriptor);
        ...
        /// </returns>
        public static bool IsValid() => PInvoke.sg_isvalid();

        /// <summary>
        ///     TODO.
        /// </summary>
        public static void ResetStateCache() => PInvoke.sg_reset_state_cache();
            ...
            byte? clearStencil = null)
        {
            ...
            ref var color = ref action.Color();
            if (clearColor == null)
            {
        ...
        /// </summary>
        public static void Commit() => PInvoke.sg_commit();
        ...
        public static GraphicsPixelFormatInfo QueryPixelFormat(GraphicsPixelFormat format) => PInvoke.sg_query_pixelformat(format);
    }
}
