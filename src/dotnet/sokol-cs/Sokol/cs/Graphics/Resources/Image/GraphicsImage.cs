...
namespace Sokol.Graphics
{
    ...
    ///         geometry is defined with <see cref="GraphicsImageSamplerFilter" /> and <see cref="GraphicsImageSamplerWrap" />.
    ...
    public readonly struct GraphicsImage
    {
        ...
        ///     Gets TODO.
        /// </summary>
        public GraphicsImageInfo Info => PInvoke.sg_query_image_info(this);

        /// <summary>
        ///     Gets TODO.
        /// </summary>
        public GraphicsResourceState State => PInvoke.sg_query_image_state(this);
        ...
        public static GraphicsImageDescriptor QueryDefaults([In] ref GraphicsImageDescriptor descriptor) =>
            PInvoke.sg_query_image_defaults(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <param name="descriptor">.</param>
        public void Initialize(ref GraphicsImageDescriptor descriptor) => PInvoke.sg_init_image(this, ref descriptor);

        /// <summary>
        ///     Destroys the <see cref="GraphicsImage" />.
        /// </summary>
        public void Destroy() => PInvoke.sg_destroy_image(this);

        /// <summary>
        ///     TODO.
        /// </summary>
        public void Fail() => PInvoke.sg_fail_image(this);
        ...
        public void Update(ref GraphicsImageContent data) => PInvoke.sg_update_image(this, ref data);
