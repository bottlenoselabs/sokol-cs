...
namespace Sokol.Graphics
{
    ...
    ///                     case and as such any option of <see cref="GraphicsImageSamplerFilter" /> is irrelevant.
    ///                 </description>
    ///             </item>
    ///             <item>
    ///                 <description>
    ...
    ///                     <see cref="GraphicsImageSamplerFilter" /> are applicable.
    ///                 </description>
    ///             </item>
    ///         </list>
    ...
    ///     </para>
    ///     <para>
    ///         Depending on the chosen <see cref="GraphicsImageSamplerFilter" />, the results (not necessarily pixels) will
    ...
    ///     </para>
    ///     <para>
    ///         <see cref="GraphicsImageSamplerFilter" /> is blittable to the C `sg_filter` enum found in `sokol_gfx`.
    ///     </para>
    /// </remarks>
    public enum GraphicsImageSamplerFilter
    {
        /// <summary>
        ///     This value is reserved for the default initialization of structures. The default
        ///     <see cref="GraphicsImageSamplerFilter" /> is <see cref="Nearest" />.
        /// </summary>
        Default,
