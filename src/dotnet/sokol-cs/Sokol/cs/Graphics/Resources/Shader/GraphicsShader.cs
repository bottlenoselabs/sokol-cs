...
namespace Sokol.Graphics
{
    ...
    public readonly struct GraphicsShader
    {
        ...
        ///     Gets TODO.
        /// </summary>
        public GraphicsShaderInfo Info => PInvoke.sg_query_shader_info(this);

        /// <summary>
        ///     Gets TODO.
        /// </summary>
        public GraphicsResourceState State => PInvoke.sg_query_shader_state(this);
        ...
        public static GraphicsShaderDescriptor QueryDefaults([In] ref GraphicsShaderDescriptor descriptor) =>
            PInvoke.sg_query_shader_defaults(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <param name="descriptor">.</param>
        public void Initialize([In] ref GraphicsShaderDescriptor descriptor) => PInvoke.sg_init_shader(this, ref descriptor);

        /// <summary>
        ///     Destroys the <see cref="GraphicsShader" />.
        /// </summary>
        public void Destroy() => PInvoke.sg_destroy_shader(this);

        /// <summary>
        ///     TODO.
        /// </summary>
        public void Fail() => PInvoke.sg_fail_shader(this);
