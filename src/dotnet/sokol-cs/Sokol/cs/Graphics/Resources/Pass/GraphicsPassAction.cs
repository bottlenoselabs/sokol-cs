...
namespace Sokol.Graphics
{
    ...
    public unsafe struct GraphicsPassAction
    {
        ...
        [FieldOffset(4)]
        private fixed int _colors[20 * GraphicsConstants.MaximumColorAttachments / 4];
        ...
        public ref GraphicsPassColorAttachmentAction Color(int index = 0)
        {
            fixed (GraphicsPassAction* passAction = &this)
            {
                var ptr = (GraphicsPassColorAttachmentAction*)&passAction->_colors[0];
