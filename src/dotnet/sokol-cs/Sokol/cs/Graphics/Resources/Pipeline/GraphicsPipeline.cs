...
namespace Sokol.Graphics
{
    ...
    public readonly struct GraphicsPipeline
    {
        ...
        ///     Gets TODO.
        /// </summary>
        public GraphicsPipelineInfo Info => PInvoke.sg_query_pipeline_info(this);

        /// <summary>
        ///     Gets TODO.
        /// </summary>
        public GraphicsResourceState State => PInvoke.sg_query_pipeline_state(this);
        ...
        public static GraphicsPipelineDescriptor QueryDefaults([In] ref GraphicsPipelineDescriptor descriptor) =>
            PInvoke.sg_query_pipeline_defaults(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <param name="descriptor">.</param>
        public void Initialize([In] ref GraphicsPipelineDescriptor descriptor) => PInvoke.sg_init_pipeline(this, ref descriptor);

        /// <summary>
        ///     Destroys the <see cref="GraphicsPipeline" />.
        /// </summary>
        public void Destroy() => PInvoke.sg_destroy_pipeline(this);

        /// <summary>
        ///     TODO.
        /// </summary>
        public void Fail() => PInvoke.sg_fail_pipeline(this);
