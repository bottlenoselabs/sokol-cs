...
namespace Sokol.Graphics
{
    ...
    public readonly struct GraphicsBuffer
    {
        ...
        /// </value>
        public bool IsOverflown => PInvoke.sg_query_buffer_overflow(this);

        /// <summary>
        ///    Gets TODO.
        /// </summary>
        public GraphicsBufferInfo Info => PInvoke.sg_query_buffer_info(this);

        /// <summary>
        ///     Gets TODO.
        /// </summary>
        public GraphicsResourceState State => PInvoke.sg_query_buffer_state(this);
        ...
        public static GraphicsBufferDescriptor QueryDefaults(ref GraphicsBufferDescriptor descriptor) =>
            PInvoke.sg_query_buffer_defaults(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <param name="descriptor">.</param>
        public void Initialize(ref GraphicsBufferDescriptor descriptor) => PInvoke.sg_init_buffer(this, ref descriptor);

        /// <summary>
        ///     Destroys the <see cref="GraphicsBuffer" />.
        /// </summary>
        public void Destroy() => PInvoke.sg_destroy_buffer(this);

        /// <summary>
        ///     TODO.
        /// </summary>
        public void Fail() => PInvoke.sg_fail_buffer(this);
        ...
        public void Update(IntPtr dataPointer, int dataSize) => PInvoke.sg_update_buffer(this, dataPointer, dataSize);
        ...
        /// <summary>
        ///     Overwrites the contents of the <see cref="GraphicsBuffer" /> by copying the pointed memory of the specified
        ///     <see cref="Memory{T}" />. The <see cref="GraphicsBuffer" /> must have been created with
        ///     <see cref="GraphicsResourceUsage.Dynamic" /> or <see cref="GraphicsResourceUsage.Stream" />.
        /// </summary>
        /// <param name="data">The block of memory to copy.</param>
        /// <typeparam name="T">The type of elements to copy into the buffer.</typeparam>
        ...
        ///     </para>
        /// </remarks>
        public int Append(IntPtr dataPointer, int dataSize) => PInvoke.sg_append_buffer(this, dataPointer, dataSize);
        ...
        /// <summary>
        ///     Appends to the contents of the <see cref="GraphicsBuffer" /> by copying the pointed memory of the specified
        ///     <see cref="Memory{T}" />. The <see cref="GraphicsBuffer" /> must have been created with
        ///     <see cref="GraphicsResourceUsage.Dynamic" /> or <see cref="GraphicsResourceUsage.Stream" />.
        /// </summary>
        /// <param name="data">The block of memory to copy.</param>
        ...
        ///     </para>
        /// </remarks>
        public int Append<T>(Memory<T> data)
            where T : unmanaged
            => Append(data.Span);
