...
namespace Sokol
{
    ...
    public unsafe struct GraphicsShaderUniformBlockDescriptor
    {
        ...
        [FieldOffset(8)]
        private readonly int _uniforms;
        ...
        public readonly ref GraphicsShaderUniformDescriptor Uniform(int index)
        {
            fixed (GraphicsShaderUniformBlockDescriptor* uniformBlockDescription = &this)
            {
                var pointer = (GraphicsShaderUniformDescriptor*)&uniformBlockDescription->_uniforms;
