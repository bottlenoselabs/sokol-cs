...
namespace Sokol
{
    ...
    public unsafe struct GraphicsShaderStageDescriptor
    {
        ...
        /// <summary>
        ///     Gets or sets the string containing the source code of the <see cref="GraphicsShader" /> stage. Must be set for
        ///     <see cref="GraphicsBackend.OpenGL" />, <see cref="GraphicsBackend.OpenGLES2" />, and
        ...
        {
            get => Native.GetStringFromBytePointer(_sourceCode);
            set => _sourceCode = Native.GetBytePointerFromString(value);
        }
        ...
        public readonly ref GraphicsShaderUniformBlockDescriptor UniformBlock(int index)
        {
            fixed (GraphicsShaderStageDescriptor* shaderStageDescription = &this)
            {
                var pointer = (GraphicsShaderUniformBlockDescriptor*)&shaderStageDescription->_uniformBlocks;
        ...
        public readonly ref GraphicsShaderImageDescriptor Image(int index = 0)
        {
            fixed (GraphicsShaderStageDescriptor* shaderStageDescription = &this)
            {
                var pointer = (GraphicsShaderImageDescriptor*)&shaderStageDescription->_images;
                return ref *(pointer + index);
            }
        }
    }
