...
namespace Sokol
{
    ...
    public unsafe ref struct GraphicsShaderDescriptor
    {
        /// <summary>
        ...
        public readonly ref GraphicsShaderVertexAttributeDescriptor Attribute(int index)
        {
            fixed (GraphicsShaderDescriptor* shaderDescription = &this)
            {
                var pointer = (GraphicsShaderVertexAttributeDescriptor*)&shaderDescription->_attributes;
