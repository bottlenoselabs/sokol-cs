...
{
    /// <summary>
    ///     Defines the different ways a vertex's attribute is encoded in a <see cref="GraphicsBuffer" />. Used by a
    ///     <see cref="GraphicsPipeline" /> to know how to read vertex attributes out of a vertex <see cref="GraphicsBuffer" />
    ///     and into the <see cref="GraphicsShaderStageType.Vertex" /> stage of a <see cref="GraphicsShader" />.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    ///     </para>
    ///     <para>
    ///         <see cref="GraphicsBackend.OpenGLES2" /> does not support integer vertex formats. This includes no support for
    ///         <see cref="UInt10N2" />. Only <see cref="Float" />, <see cref="Float2" />, <see cref="Float3" />, and
    ///         <see cref="Float4" /> are
    ...
    ///         <see cref="GraphicsBackend" />, use one of the following vertex formats:
    ...
    public enum PipelineVertexAttributeFormat
    {
        ...
        /// <summary>
        ///     The vertex attribute slot is read and used as a <see cref="float" /> value. Total read size is <c>4</c> bytes.
        /// </summary>
        Float,

        /// <summary>
        ///     The vertex attribute slot is read and used as two <see cref="float" /> values. Total read size is <c>8</c> bytes.
        /// </summary>
        Float2,

        /// <summary>
        ///     The vertex attribute slot is read and used as three <see cref="float" /> values. Total read size is <c>12</c>
        ///     bytes.
        /// </summary>
        Float3,

        /// <summary>
        ///     The vertex attribute slot is read and used as four <see cref="float" /> values. Total read size is <c>16</c> bytes.
        /// </summary>
        Float4,

        /// <summary>
        ///     The vertex attribute slot is read as four packed <see cref="sbyte" /> components and each component is
        ///     unpacked to a un-normalized, signed <see cref="float" /> value. Total read size is <c>4</c> bytes. If using
        ///     <see cref="GraphicsBackend.Direct3D11" /> each packed component is not unpacked to a float, but
        ...
        ///     unpacked to a un-normalized, un-signed <see cref="float" /> value. Total read size is <c>4</c> bytes. If using
        ///     <see cref="GraphicsBackend.Direct3D11" /> each packed component is not unpacked to a float, but rather an integer
        ///     component.
        /// </summary>
        UByte4,
        ...
        /// <summary>
        ///     The vertex attribute slot is read as four packed <see cref="byte" /> components and each component is
        ///     unpacked to a normalized, un-signed <see cref="float" /> value in the range of <c>0.0f</c> to <c>+1.0f</c>. Total
        ///     read size is <c>4</c> bytes.
        /// </summary>
        UByte4N,
        ...
        ///     unpacked to a un-normalized, signed <see cref="float" /> value. Total read size is <c>8</c> bytes. If using
        ///     <see cref="GraphicsBackend.Direct3D11" /> each packed component is not unpacked to a float, but
        ///     rather an integer component.
        /// </summary>
        Short4,
        ...
        ///     and 2-bits. Each component is converted to a normalized, signed, float value in the range of <c>-1.0f</c> to
        ///     <c>+1.0f</c>. Total read size <c>4</c> bytes.
        /// </summary>
        UInt10N2
    }
}
