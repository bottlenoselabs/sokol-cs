...
namespace Sokol
{
    ...
    /// <remarks>
    ///     <para>
    ///         <see cref="GraphicsImageWrap" /> is blittable to the C `sg_wrap` enum found in `sokol_gfx`.
    ///     </para>
    /// </remarks>
    public enum GraphicsImageWrap
    {
        /// <summary>
        ///     This value is reserved for the default initialization of structures. The default
        ///     <see cref="GraphicsImageWrap" /> is <see cref="GraphicsImageWrap.Repeat" />.
        /// </summary>
        Default,
