...
namespace Sokol
{
    ...
    public readonly unsafe struct GraphicsPass
    {
        ...
        ///     Gets TODO.
        /// </summary>
        public GraphicsPassInfo Info => GraphicsPInvoke.sg_query_pass_info(this);

        /// <summary>
        ///     Gets TODO.
        /// </summary>
        public GraphicsResourceState State => GraphicsPInvoke.sg_query_pass_state(this);
        ...
        public static GraphicsPassDescriptor QueryDefaults([In] ref GraphicsPassDescriptor descriptor) => GraphicsPInvoke.sg_query_pass_defaults(ref descriptor);

        /// <summary>
        ///     TODO.
        /// </summary>
        /// <param name="descriptor">.</param>
        public void Initialize([In] ref GraphicsPassDescriptor descriptor) => GraphicsPInvoke.sg_init_pass(this, ref descriptor);

        /// <summary>
        ///     Destroys the <see cref="GraphicsPass" />.
        /// </summary>
        public void Destroy() => GraphicsPInvoke.sg_destroy_pass(this);

        /// <summary>
        ///     TODO.
        /// </summary>
        public void Fail() => GraphicsPInvoke.sg_fail_pass(this);
        ...
        public void Begin([In] ref GraphicsPassAction passAction) => GraphicsPInvoke.sg_begin_pass(this, ref passAction);

        /// <summary>
        ///     Ends the <see cref="GraphicsPass" />.
        /// </summary>
        [SuppressMessage("Microsoft.Performance", "CA1822", Justification = "C# API design.")]
        public void End() => GraphicsPInvoke.sg_end_pass();
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822", Justification = "C# API design.")]
        public void ApplyPipeline(GraphicsPipeline pipeline) => GraphicsPInvoke.sg_apply_pipeline(pipeline);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822", Justification = "C# API design.")]
        public void ApplyBindings([In] ref GraphicsResourceBindings bindings) => GraphicsPInvoke.sg_apply_bindings(ref bindings);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822", Justification = "C# API design.")]
        public void ApplyUniforms<T>(GraphicsShaderStageType stage, [In] ref T value, int uniformBlockIndex = 0)
            where T : unmanaged
        {
            var dataPointer = Unsafe.AsPointer(ref value);
            var dataSize = Marshal.SizeOf<T>();
            GraphicsPInvoke.sg_apply_uniforms(stage, uniformBlockIndex, dataPointer, dataSize);
        }
        ...
        public void ApplyViewport(int x, int y, int width, int height, bool originIsTopLeft = false) =>
            GraphicsPInvoke.sg_apply_viewport(x, y, width, height, originIsTopLeft);
        ...
        public void ApplyScissor(int x, int y, int width, int height, bool originIsTopLeft = false) =>
            GraphicsPInvoke.sg_apply_scissor_rect(x, y, width, height, originIsTopLeft);
        ...
        public void DrawElements(int elementCount, int baseElement = 0, int instanceCount = 1) =>
            GraphicsPInvoke.sg_draw(baseElement, elementCount, instanceCount);
